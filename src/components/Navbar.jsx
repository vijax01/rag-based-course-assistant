        ...
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className='flex justify-center items-center gap-0.5' >
                ...
                <p className='text-2xl font-medium' >
                    Course A<span className='text-indigo-500' >ss</span>istant
                </p>
            </div>

            {/* Desktop Menu */}
            <div className="hidden sm:flex items-center font-light gap-8">
                <Link
                    to="/"
                ...
                <Link to="/my-learnings" className={`hover:text-indigo-500 ${location.pathname === "/my-learnings" ? "text-indigo-500" : ""} `}>
                    My Learnings
                </Link>

                <div className="flex items-center gap-2 border border-gray-300 px-3 rounded-full w-65">
                    <input
                        className="py-1.5 w-full bg-transparent text-sm outline-none placeholder-gray-500"
                        type="text"
                        placeholder="Search"
                    />
                ...
                <div className='hover:text-indigo-500 cursor-pointer' >
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user-round-icon lucide-user-round"><circle cx="12" cy="8" r="5" /><path d="M20 21a8 8 0 0 0-16 0" /></svg>
                </div>
            ...
            <div className={`${open ? 'flex' : 'hidden'} absolute top-15 left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden`}>
                ...
                <a href="#" className="block">Subscribe</a>
